...
import static cn.xdean.jex.util.lang.PrimitiveTypeUtil.toPrimitiveArray;
import static cn.xdean.jex.util.lang.PrimitiveTypeUtil.toWrapperArray;
...
public class ArrayUtil {
  ...
  public static <T> T[][] transpose(T[][] origin) {
    Class<? extends Object[][]> clz =  origin.getClass();
