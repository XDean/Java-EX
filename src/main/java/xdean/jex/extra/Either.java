...
public interface Either<L, R> {
  ...
  Either<L, R> ifLeft(Consumer<? super L> f);

  Either<L, R> ifRight(Consumer<? super R> f);
...
class Left<L, R> implements Either<L, R> {
  ...
  @Override
  public Either<L, R> ifRight(Consumer<? super R> f) { /* do nothing */
    return this;
  }
...
class Right<L, R> implements Either<L, R> {
  ...
  @Override
  public Either<L, R> ifLeft(Consumer<? super L> f) { /* do nothing */
    return this;
  }
