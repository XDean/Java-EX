 ...
 *
 * THIS SOFTWARE, IN SOURCE CODE, OBJECT CODE AND SCRIPT FORM, IS THE PROPRIETARY AND CONFIDENTIAL
 * INFORMATION OF ASML NETHERLANDS B.V. (AND ITS AFFILIATES) AND IS PROTECTED BY U.S. AND
 * INTERNATIONAL LAW. ANY UNAUTHORIZED USE, COPYING AND DISTRIBUTION OF THIS SOFTWARE, IN SOURCE
 * CODE, OBJECT CODE AND SCRIPT FORM, IS STRICTLY PROHIBITED. THIS SOFTWARE, IN SOURCE CODE, OBJECT
 * CODE AND SCRIPT FORM IS PROVIDED ON AN "AS IS" BASIS WITHOUT WARRANTY, EXPRESS OR IMPLIED. ASML
 * NETHERLANDS B.V. EXPRESSLY DISCLAIMS THE IMPLIED WARRANTIES OF MERCHANTABILITY AND FITNESS FOR A
 * PARTICULAR PURPOSE AND ASSUMES NO RESPONSIBILITY FOR ANY ERRORS THAT MAY BE INCLUDED IN THIS
 * SOFTWARE, IN SOURCE CODE, OBJECT CODE AND IN SCRIPT FORM. ASML NETHERLANDS B.V. RESERVES THE
 * RIGHT TO MAKE CHANGES TO THE SOFTWARE, IN SOURCE CODE, OBJECT CODE AND SCRIPT FORM WITHOUT
 * NOTICE.
 ******************************************************************************/
