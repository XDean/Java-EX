...
public class TraverseTest {
  ...
  public void testPreOrderTraversal() throws Exception {
    Traverse.preOrderTraversal(1, i -> i < 10 ? Arrays.asList(i * 2, i * 2 + 1) : Collections.emptyList())
        .test()
  ...
  public void testPostOrderTraversal() throws Exception {
    Traverse.postOrderTraversal(1, i -> i < 10 ? Arrays.asList(i * 2, i * 2 + 1) : Collections.emptyList())
        .test()
  ...
  public void testBreadthFirstTraversal() throws Exception {
    Traverse.breadthFirstTraversal(1, i -> i < 10 ? Arrays.asList(i * 2, i * 2 + 1) : Collections.emptyList())
        .test()
