...
import xdean.jex.extra.json.JsonPrinter.PrintIdPolicy;
...
public class JsonPrinterTest {
  ...
  public void test() throws Exception {
    ...
    assertWith(JsonPrinter.getDefault().printIdPolicy(PrintIdPolicy.ALL).toString(d), "allId");
    assertWith(JsonPrinter.getDefault().printIdPolicy(PrintIdPolicy.OFF).toString(d), "noId");
  }
